...
class _ProductListState extends State<ProductList> {
  void _showProductDetail (BuildContext context, Product product, int index) {
      int photo = 0;
      showDialog( 
        context: context,
                        ...
                        Row( 
                          ...
                          children: [ 
                            TextButton(
                              onPressed: (){
                                setState(() {
                                  photo = (photo-1 + product.images.length) % product.images.length;
                                });
                              }, 
                              child: const Icon(Icons.arrow_left_rounded)
                            ),
                            Image(
                              image: AssetImage('assets/product_images/${product.images[photo]}.png'),
                              width: 150,  height: 150,
                            ),
                            TextButton(
                              onPressed: (){
                                setState(() {
                                  photo = (photo + 1) % product.images.length;
                                });
                              }, 
              ...
              child: Wrap(
                  ...
                  children: widget.productList.asMap().entries.map((entry) {
                    ...
                    return GestureDetector(
                      onTap: () {_showProductDetail(context, e, index);},
                      child:  Container( 
