...
class _SearchProductViewState extends State<SearchProductView> {
  ...
  List<Product> recommendedForYou = [
    Product(description: 'description1 oi zkzks  n,kpq^dl qskdp jjjjjjjj kkkkkkk o nnkkk llll ppppp eeeee ttt y y m zz eer zzzz eedd eer zzz zzz ee eee pppp jjj hhhh fder', price: 14.0, images: ['coat', 'robe', 'coat', 'robe'], id: 1, name: 'robe', nbrAchat: 18),
